...
class Modelo_subfamilia extends CI_Model {

    var $table = 'sub_familia';
    var $column_order = array('id_sub_familia', null); 
    var $column_search = array('id_sub_familia','nombre');
    var $order = array('id_sub_familia' => 'desc');
    ...
    public function eliminar_por_id($id) {
      ...
      public function obtener_subfamilia_por_familia($id) {
        $this->db->from($this->table);

                    ...
                    <script type="text/javascript">
                        ...
                        function Guardar()
                        {
                            ...
                            if (guardar_metodo == 'add') {
                                url = "<?php echo site_url('Cierre/Controlador_masivo/Agregar_datos_cierre_masivo') ?>";
                            } else {
                        ...
                        function eliminar(id)
                        {
                            if (confirm('Esta seguro de eliminar los datos?'))
                            {
                                ...
                                $.ajax({
                                    url: "<?php echo site_url('Cierre/Controlador_masivo/Eliminar_cierre_masivo') ?>/" + id,
                                    type: "POST",
                                    dataType: "JSON",
                                    success: function (data)
                                    {
                        ...
                        function obtener_stock() {
                            $.ajax({
                                "url": "<?php echo site_url('Cierre/Controlador_masivo/obtener_stock') ?>",
                                type: "POST",
                                data: $('#form').serialize(),
                                dataType: "JSON",
                                success: function (data)

            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <h4>FAMILIA<small> <?php echo $this->session->userdata('id_familia'); ?></small></h4>
                        <h4 class="text-primary text-right" >Fecha: <small> <?php echo $this->session->userdata('fecha'); ?></small></h4>
  <h3>Cierre de Sub-Agente</h3>
                    </div>
                    <div class="x_content">
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function () {
                            /*
                             $.get('<?php echo site_url('Cierre/Controlador_cierre_estandar/Listar_datos_guia') ?>',function(data){
                        ...
                        function Guardar()
                        {
                            ...
                            if (guardar_metodo == 'add') {
                                url = "<?php echo site_url('Cierre/Controlador_cierre_estandar/Agregar_datos') ?>";
                            } else {
                        ...
                        function eliminar(id)
                        {
                            if (confirm('Esta seguro de eliminar los datos?'))
                            {
                                ...
                                $.ajax({
                                    url: "<?php echo site_url('Cierre/Controlador_cierre_estandar/Eliminar_estandar') ?>/" + id,
                                    type: "POST",
                                    dataType: "JSON",
                                    success: function (data)
                                    {
                            ...
                            if (cantidad == "") {
                                ...
                                $.ajax({
                                    ...
                                    success: function (data)
                                    {
                                        ...
                                        $('[name="total"]').val(data.total-data.total*0.06);
                                        $('[name="monto"]').val(data.monto-data.monto*0.06);
                        ...
                        function obtener_stock() {
                            $.ajax({
                                "url": "<?php echo site_url('Cierre/Controlador_cierre_estandar/obtener_stock') ?>",
                                type: "POST",
                                data: $('#form').serialize(),
                                dataType: "JSON",
                                success: function (data)
                                        ...
                                        <div class="form-body">
                                            <div class="x_panel">
                                                ...
                                                <div class="form-group">
                                                 ...
                                                 <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="descuento">Descuento Sub-Agente <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name ="descuento" id="descuento" value="6 % Descuento"  required="required" class="form-control col-md-7 col-xs-12" disabled="true">
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="stock">Stock de Producto <span class="required">*</span>
                                                    </label>
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input type="text" name ="stock" id="stock"  required="required" class="form-control col-md-7 col-xs-12" disabled="true">
                                                        <span class="help-block"></span>
                                                    </div>
                                                </div>
                                                <div class="form-group">

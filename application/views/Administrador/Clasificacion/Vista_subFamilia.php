    ...
    <div class=""> 
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Listado Sub Familia de Proveedores <small> administrador</small></h2>

                    </div>
                    <div class="x_content">
                        <p class="text-muted font-13 m-b-30">
                            Usuarios con privilegio de administrador, estos pueden modificar,eliminar y añadir Sub Familia pertenecientes a Proveedores.
                        </p>
                        <button class="btn btn-success" onclick="add_person()"><i class="glyphicon glyphicon-plus"></i> Agregar Sub Familia</button>
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function () {
                            ...
                            table = $('#table').DataTable({
                                ...
                                "ajax": {
                                    "url": "<?php echo site_url('Administrador/Clasificacion/Controlador_subfamilia/Listar_datos') ?>",
                                    "type": "POST"
                                },
                        ...
                        function editar(id)
                        {
                            ...
                            $.ajax({
                                url: "<?php echo site_url('Administrador/Clasificacion/Controlador_subfamilia/Editar_datos/') ?>/" + id,
                                type: "GET",
                                dataType: "JSON",
                                success: function (data)
                                {
                                    ...
                                    $('.modal-title').text('Editar Sub_Familia'); // Titulo del Modal
                        ...
                        function save()
                        {
                            ...
                            if (guardar_metodo == 'add') {
                                url = "<?php echo site_url('Administrador/Clasificacion/Controlador_subfamilia/Agregar_datos') ?>";
                            } else {
                                url = "<?php echo site_url('Administrador/Clasificacion/Controlador_subfamilia/Actualizar_datos') ?>";
                            }
                        ...
                        function eliminar(id)
                        {
                            if (confirm('Esta Seguro de eliminar los datos?'))
                            {
                                ...
                                $.ajax({
                                    url: "<?php echo site_url('Administrador/Clasificacion/Controlador_subfamilia/Eliminar_datos') ?>/" + id,
                                    type: "POST",
                                    dataType: "JSON",
                                    success: function (data)
                                    {
...
<script src="<?php echo base_url(""); ?>assets/js/Categoria_Proveedor_Familia.js"></script>

    ...
    <div class=""> 
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <h2>Listado Productos en Bodega <small>Sucursal</small></h2>
                    ...
                    <script type="text/javascript">
                        ...
                        $(document).ready(function () {
                            table = $('#table').DataTable({
                                ...
                                "order": [], 
                                "ajax": {
                                    "url": "<?php echo site_url('Sucursal/Controlador_bodega/Listar_Bodega_sucursal') ?>",
                                    "type": "POST"
                                },
                                "columnDefs": [
                                    {
                        ...
                        function editar(id)
                        {
                            ...
                            $.ajax({
                                url: "<?php echo site_url('Sucursal/Controlador_bodega/editar/') ?>/" + id,
                                type: "GET",
                                dataType: "JSON",
                        ...
                        function Guardar()
                        {
                            ...
                            if (save_method == 'add') {
                                url = "<?php echo site_url('Sucursal/Controlador_bodega/Guardar') ?>";
                            } else {
                                url = "<?php echo site_url('Sucursal/Controlador_bodega/Actualizar') ?>";
                            }
                        ...
                        function eliminar(id)
                        {
                            if (confirm('Esta seguro de eliminar los datos?'))
                            {
                                ...
                                $.ajax({
                                    url: "<?php echo site_url('Sucursal/Controlador_bodega/Eliminar') ?>/" + id,
                                    type: "POST",
                                    dataType: "JSON",
                                    success: function (data)
                                    {
